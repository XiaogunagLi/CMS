...
<html>
  <head>
    ...
    <script type="text/javascript">
			window.onload = function() {
			 ...
			 $("#eve").css("background-image", "url(show/img/navSelectBg.png)");
  ...
  <body>
   		...
   		<div>
   		     ...
   		     <%
   	        		List<Model_Default> classList = (List<Model_Default>)show.getContentsByDirId("Model_Default", 5); 
   	        	...
   	        	%>
   	        		 <div class="teacher">
		   		     	...
		   		     	<div class="teacher_content">
		   		     		...
		   		     		<a href="show/eveInfo.jsp?id=<%= t.getId()%>"> <img src="show/img/info.png"></a>

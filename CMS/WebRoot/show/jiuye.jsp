  ...
  <head>
    ...
    <script type="text/javascript">
			window.onload = function() {
				aaa();
				navSelect();
			$("#jiuye").css("background-image", "url(show/img/navSelectBg.png)");
				
				$(".nav_label").bind("mouseout", function(){
						if($(this).attr("id") == "jiuye"){
						}else{
   		...
   		<div>
   			 <div style="border-bottom: 1px solid #aaa;width: 1100;height: 40;margin-left: auto;margin-right: auto; margin-top: 10px;">
   			 	<span class = "content_head">
   	               <label style="color: #090;"><b>就业创业</b> </label>
   		     ...
   		     <%
   		 	 List<Model_Default> jiuyeList = (List<Model_Default>)show.getContentsByDirId("Model_Default", 7); 

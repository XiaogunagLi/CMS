   		...
   		<div>
   		     ...
   		     <div style="border: 0px solid #ddd;width: 1100;height: 550;
	             ...
	             color:#252525;line-height:25px;padding: 5px;">
   		     	 &nbsp;&nbsp;
   		     	 <form action="show/baomingOption.jsp" method="post">
   		     	 <center>
	   		     	 <table width="500px" border="0">
	   		     	 	<tr height="40px">
	   		     	 		<td width="20%" align="right">姓名</td>
	   		     	 		<td width="75%"><input style="width: 300px; height: 30px;" type="text" name="name" class="aaa"></td>
	   		     	 	</tr>
	   		     	 	
	   		     	 	<tr height="40px">
	   		     	 		<td width="20%" align="right">性别</td>
	   		     	 		<td width="75%">
	   		     	 			<select name="sex" class="aaa">
	   		     	 	...
	   		     	 	<tr height="40px">
	   		     	 		...
	   		     	 		<td width="75%"><input style="width: 300px; height: 30px;" type="text" name="phone" class="aaa"></td>
	   		     	 	</tr>
	   		     	 	
	   		     	 	<tr height="40px">
	   		     	 		<td width="20%" align="right">验证码</td>
	   		     	 		<td width="75%">
	   		     	 			<input style="width: 200px; height: 30px;" type="text" name="code" class="aaa">

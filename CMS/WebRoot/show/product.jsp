  ...
  <head>
    ...
    <script type="text/javascript">
			window.onload = function() {
				...
				$("#product").css("background-image", "url(show/img/navSelectBg.png)");
   		...
   		<div>
   			 <div style="border-bottom: 1px solid #aaa;width: 1100;height: 40;margin-left: auto;margin-right: auto; margin-top: 10px;">
   			 	<span class = "content_head">
   	               <label style="color: #090;"><b>产品介绍</b> </label>
   	               <label style="color: #ada; margin-left: 100px;">免费咨询热线：600-616-879</label>
   	       		</span>
   			 </div>
   			 
   		     <%
   	        		List<Model_Default> classList = (List<Model_Default>)show.getContentsByDirId("Model_Default", 6); 
   	        	...
   	        	%>
   	        		 <div class="teacher">
		   		     	...
		   		     	<div class="teacher_content">
		   		     		...
		   		     		<a href="show/productInfo.jsp?id=<%= t.getId()%>"> <img src="show/img/info.png"></a>

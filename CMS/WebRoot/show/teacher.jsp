  ...
  <head>
    ...
    <script type="text/javascript">
			window.onload = function() {
				...
				$("#teacher").css("background-image", "url(show/img/navSelectBg.png)");
   		...
   		<div>
   			 <div style="border-bottom: 1px solid #aaa;width: 1100;height: 40;margin-left: auto;margin-right: auto; margin-top: 10px;">
   			 	<span class = "content_head">
   	               <label style="color: #090;"><b>专家师资</b> </label>
   	        	...
   	        	%>
		   		     ...
		   		     <div class="teacher_content">
		   		     		...
		   		     		<a href="show/teacherInfo.jsp?id=<%= t.getId()%>"> <img src="show/img/info.png"></a>
